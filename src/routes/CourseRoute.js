...
const { AllCourses, AddCourse, CoursesDelete, GetCourseById, GetUniversityCourseList, GetCourseByName, UpdateCourse, DeleteCourseBySlug, GetAllCourses } = require("../controllers/CourseController");

...
const { ApprovalAdd, ApprovalEdit, PlacementAdd, PlacementEdit, ApprovalSoftDelete, PlacementSoftDelete, ApprovalandPlacements } = require("../Controllers/ApprovalController");

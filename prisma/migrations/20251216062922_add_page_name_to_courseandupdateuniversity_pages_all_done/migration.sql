...
CREATE TABLE "CourseFees" (
    ...
    CONSTRAINT "CourseFees_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "CourseSkills" (
    ...
    CONSTRAINT "CourseSkills_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "CourseSkills_course_id_key" ON "CourseSkills"("course_id");
...
-- CreateIndex
CREATE UNIQUE INDEX "CourseCareer_course_id_key" ON "CourseCareer"("course_id");
...
-- AddForeignKey
ALTER TABLE "CourseFees" ADD CONSTRAINT "CourseFees_course_id_fkey" FOREIGN KEY ("course_id") REFERENCES "Course"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "CourseSkills" ADD CONSTRAINT "CourseSkills_course_id_fkey" FOREIGN KEY ("course_id") REFERENCES "Course"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "CourseCareer" ADD CONSTRAINT "CourseCareer_course_id_fkey" FOREIGN KEY ("course_id") REFERENCES "Course"("id") ON DELETE SET NULL ON UPDATE CASCADE;

...
CREATE TABLE "Course" (
    ...
    "updated_at" TIMESTAMP(3) NOT NULL,
    "deleted_at" TIMESTAMP(3),
    "hard_copy" BOOLEAN DEFAULT false,
    "soft_copy" BOOLEAN DEFAULT false,
    "campus_library_access" BOOLEAN DEFAULT false,
...
CREATE TABLE "Review" (
    ...
    "course_curriculum" DOUBLE PRECISION,
